...
class TestIsValid:
    ...
    def test_very_long_valid_string(self):
        ...
        long_string = "()" * 1000
        assert is_valid(long_string) is True
...
class TestNumTrees:
    ...
    def test_catalan_numbers(self):
        ...
        for n, expected_val in enumerate(expected):
            assert num_trees(n) == expected_val

    def test_larger_values(self):
        """Test larger values"""
        assert num_trees(10) == 16796
        assert num_trees(12) == 208012
...
class TestLengthOfLis:
    ...
    def test_already_sorted(self):
        ...
        assert length_of_lis([1, 2, 3]) == 3

    def test_reverse_sorted(self):
        """Test with reverse sorted array"""
        assert length_of_lis([5, 4, 3, 2, 1]) == 1
        assert length_of_lis([3, 2, 1]) == 1

    def test_all_same_elements(self):
        """Test with all same elements"""
        assert length_of_lis([7, 7, 7, 7]) == 1
        assert length_of_lis([1, 1, 1]) == 1

    def test_alternating_values(self):
        """Test with alternating values"""
        assert length_of_lis([1, 3, 2, 4, 3, 5]) == 4  # 1,2,3,5 or 1,3,4,5 etc
    ...
    def test_mixed_positive_negative(self):
        ...
        assert length_of_lis([-1, 3, -2, 4, 5]) == 4  # -1,3,4,5 or -2,4,5 etc
...
# ============================================================================
# TEST FUNCTIONS - FIND MEDIAN SORTED ARRAYS
# ============================================================================
...
def find_median_sorted_arrays(nums1: List[int], nums2: List[int]) -> float:
    ...
    if not all(
        isinstance(x, (int, float)) and not isinstance(x, bool) for x in nums1 + nums2
    ):
...
class TestFindMedianSortedArrays:
    ...
    def test_large_arrays(self):
        ...
        assert find_median_sorted_arrays(nums1, nums2) == 499.5
...
class TestMaxPathSum:
    ...
    def test_single_node(self):
        ...
        root_neg = TreeNode(-3)
        assert max_path_sum(root_neg) == -3
