...
class TestLongestSubstringWithoutRepeating(unittest.TestCase):
    ...
    def test_with_spaces(self):
        """Test with spaces"""
        self.assertEqual(longest_substring_without_repeating('a b c a'), 3)  # ' b c a' or 'a b c '
    ...
    def test_very_long_string_all_unique(self):
        ...
        self.assertEqual(longest_substring_without_repeating(long_unique), len(long_unique))
