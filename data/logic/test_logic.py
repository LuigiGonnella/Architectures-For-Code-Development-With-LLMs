...
def test_fizzbuzz_up_to_5():
    """Test FizzBuzz up to 5"""
    expected = ["1", "2", "Fizz", "4", "Buzz"]
    assert fizzbuzz(5) == expected


def test_fizzbuzz_with_multiple_15s():
...
def test_fizzbuzz_n_equals_1():
    """Test with n = 1"""
    assert fizzbuzz(1) == ["1"]


def test_fizzbuzz_large_n():
    """Test with large n"""
    result = fizzbuzz(100)
...
def test_invalid_sudoku_duplicate_in_row():
...
def test_next_permutation_non_list():
    """Test with non-list input"""
    with pytest.raises(TypeError):
        next_permutation("123")


def test_next_permutation_non_integers():
...
def test_n_queens_non_integer():
    """Test with non-integer input"""
    with pytest.raises(TypeError):
        solve_n_queens("4")


def test_n_queens_zero():
    """Test with zero"""
    with pytest.raises(ValueError):
        solve_n_queens(0)


def test_n_queens_negative():
    """Test with negative number"""
    with pytest.raises(ValueError):
        solve_n_queens(-1)
