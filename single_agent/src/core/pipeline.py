...
def build_single_agent_graph():
    ...
    graph.add_edge(START, "preprocessing_node")
    graph.add_edge("preprocessing_node", "analysis_node")
    graph.add_edge("analysis_node", "planning_node")
    graph.add_edge("planning_node", "generation_node")
    graph.add_edge("generation_node", "review_node")
    graph.add_edge("review_node", "refinement_node")
